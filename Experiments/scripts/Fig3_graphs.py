...
length_df = pd.read_csv('Experiments/Results/PD-var-ILP-increasing-lengths.csv')
...
variant_df = pd.read_csv('Experiments/Results/PD-var-ILP-increasing_variants.csv')
...
protein_df = pd.read_csv("Experiments/Results/PD-var-ILP-different-proteins.csv")
...
plt.savefig("Experiments/Results/figure3.png", dpi=300)
