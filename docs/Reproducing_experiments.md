...
- **Output:** `Results/PD_mul_Greedy_summary.csv`, `Results/PD_mul_Greedy_per_protein_metrics.csv`, and `Results/PD_mul_Greedy_selected_primers.csv`. 
...
Solves the multi-protein ILP on the same 1…10 sequence prefixes. Requires Gurobi. 
...
- **Output:** `Results/PD-var-ILP-increasing-lengths.csv`.
...
- **Output:** `Results/PD-var-ILP-increasing_variants.csv`.
...
- **Output:** `Results/PD-var-ILP-different-proteins.csv`. 
